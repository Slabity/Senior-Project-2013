...
//Add the two variables and return a new Vector2d.
Vector2d Vector2d::operator+(const Vector2d &v) const
{
    return Vector2d(x+v.x, y+v.y);
}

//Subtract the two variables and return a new Vector2d.
Vector2d Vector2d::operator-(const Vector2d &v) const
{
    return Vector2d(x-v.x, y-v.y);
}

//Multiply the two variables and return a new Vector2d.
Vector2d Vector2d::operator*(const Vector2d &v) const
{
    return Vector2d(x*v.x, y*v.y);
}

//Divide the two variables and return a new Vector2d.
Vector2d Vector2d::operator/(const Vector2d &v) const
{
    return Vector2d(x/v.x, y/v.y);
}
...
bool Vector2d::operator>=(const Vector2d &v) const
{
    return (*this > v) || (x*x + y*y) == (v.x*v.x + v.y*v.y);
}
